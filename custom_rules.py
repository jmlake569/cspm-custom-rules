#!/usr/bin/env python3
"""
Trend Vision One Conformity Custom Rules Manager

This script manages custom rules in Trend Vision One using the conformity API.
It can list existing custom rules and create new ones, including an IAM access key 
rotation rule that ensures keys are rotated every 180 days.

Usage:
    python custom_rules.py --api-key YOUR_API_KEY --list
    python custom_rules.py --api-key YOUR_API_KEY --create --rule-file rule.json
